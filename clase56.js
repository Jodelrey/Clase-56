...
//Funcional: se usan funciones puras.No se permiten funciones que tengan efectos secundarios, y, cuando son necesarios los hace con atajos a traves de funciones puras que permitan efectos secundarios. Es algo muy academico y tradicional

//Imperativo: programar usando todas las instrucciones de control (if, bucles)

//OOP (programacion orientada a objetos): es el paradigma mas utilizado. La utilizan lenguajes mas populares: Java, PHP, C#. Consiste en que todo es un objeto, todo se trata de representar como objetos. Las unidades basicas de trabajo son objetos. 
